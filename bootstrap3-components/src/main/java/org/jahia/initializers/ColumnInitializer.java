...
public class ColumnInitializer extends AbstractChoiceListRenderer implements ModuleChoiceListInitializer, ModuleChoiceListRenderer {
    ...
    public List<ChoiceListValue> getChoiceListValues(ExtendedPropertyDefinition epd, String param, List<ChoiceListValue> values,
        ...
        myChoiceList.add(new ChoiceListValue("predefined",myPropertiesMap,new ValueImpl("predefinedColumns", PropertyType.STRING, false)));

        //custom
        myPropertiesMap = new HashMap<String, Object>();
        myPropertiesMap.put("addMixin","bootstrap3mix:customColumns");
